...
struct MenuBarView: View {
    ...
    var body: some View {
        Button { if !model.isOnboarding, let lesson = model.recommendedLesson { model.startLesson(lesson) }; openWindow(id: "main") } label: { Label(model.isOnboarding ? "Начать обучение" : "Продолжить урок", systemImage: "play.fill") }
