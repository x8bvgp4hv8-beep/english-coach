...
/**
 * 3000 частых слов: охват частотного ядра и работа с ним.
 *
 * Экран отвечает на один вопрос — «сколько из этих 3000 я уже знаю», — и даёт два
    ...
    <>
      <header className="header">
        <div className="header-top">
          ...
          <h1 className="brand-title" style={{ flex: 1, textAlign: 'center' }}>3000 слов</h1>
          <span style={{ width: 48 }} />
        </div>
      </header>
