    ...
    <>
      ...
      <div className="scroll">
        ...
        <div className="section-title">
          <h2>Голос</h2>
          <p>
            Слова частотного списка озвучены заранее и лежат в приложении — их ничего настраивать
            не надо. Выбор ниже — чей голос: мужской или женский. Фразы уроков читает система.
          </p>
        </div>
        {genders.length > 0 ? (
